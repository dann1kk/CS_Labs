...
class blowfish:
    ...
    # encrypt a 8-byte block of text, which should be 8 byte string and return encrypted string 
    # use endianness for encryption
    ...
    # decrypt block of text and return string of plaintext
    ...
    # call for correct block size
    def blocksize (self):
        return 8

    # call for max key length in bytes
    def key_length (self):
        return 56
